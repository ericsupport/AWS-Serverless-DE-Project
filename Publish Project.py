...
QUERY_RESULTS_BUCKET = 's3://em-query-result-storage-from-athena-de-proj-aug-2024-proj-1/'
MY_DATABASE = 'em_proj_de_aug_2024_db'
SOURCE_PARQUET_TABLE_NAME = 'weather_proj_em1'
NEW_PROD_PARQUET_TABLE_NAME = 'weather_meteo_project_em1_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-weather-table-prod-1-2-3/'
