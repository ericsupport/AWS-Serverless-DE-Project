...
NEW_TABLE_NAME = 'weather_proj_em1'
NEW_TABLE_S3_BUCKET = 's3://parquet-bucket-em-proj-1/'
MY_DATABASE = 'em_proj_de_aug_2024_db'
QUERY_RESULTS_S3_BUCKET = 's3://em-query-result-storage-from-athena-de-proj-aug-2024-proj-1'
